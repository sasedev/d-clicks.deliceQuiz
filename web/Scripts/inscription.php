...
<body style="margin:0px; padding:0px; background-color:#e47907;">
<center>
<br />
<br />
...
<noscript>
	<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553555700" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,0,0" width="282" height="204" id="selartistic_agency" align="middle">
	<param name="allowScriptAccess" value="sameDomain" />
	<param name="allowFullScreen" value="false" />
	<param name="movie" value="http://www.lequizdelice.com/bravo.swf" /><param name="quality" value="high" /><param name="bgcolor" value="#e47907" />	<embed src="http://www.lequizdelice.com/bravo.swf" quality="high" bgcolor="#e47907" width="282" height="204" name="Bravo" align="middle" allowScriptAccess="sameDomain" allowFullScreen="false" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />
	</object>
</noscript>
<br />
<br />
<a href="http://www.lequizdelice.com/lequizdelice.php" onClick="javascript:window.open("http://www.lequizdelice.com/lequidelice.php","Le Quiz","channelmode=yes,directories=no,location=no,menubar=no,scrollbars=yes,status=no,toolbar=no");javascript:window.close();" style="border:0px;"><img src="http://www.lequizdelice.com/images/souris2.gif" border="0px" title="Cliquez pour Jouer"></a>
</center>
</body>
</html>
<?php
...
if(document.getElementById)
   ...
   document.write('<IMG SRC="images/souris.gif" BORDER=0 HSPACE=0 VSPACE=0 NAME=tete ALT="Répondez à 5 questions parmis les 20 proposées">');
   document.write('</A>');
   document.write('</DIV>');
   }
</SCRIPT>
